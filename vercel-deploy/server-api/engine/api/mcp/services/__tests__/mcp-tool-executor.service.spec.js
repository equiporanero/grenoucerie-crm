...
describe('McpToolExecutorService', ()=>{
    ...
    beforeEach(()=>{
        ...
        service = new _mcptoolexecutorservice.McpToolExecutorService(metricsService);
    });
    ...
    describe('handleToolCall', ()=>{
        ...
        it('should emit progress notification via sseWriter before execution', async ()=>{
            ...
            await service.handleToolCall('sse-1', toolSet, {
                name: 'my_tool',
                arguments: {}
            }, sseWriter);
            ...
            expect(sseWriter).toHaveBeenCalledWith({
                ...
                params: {
                    progressToken: `${_mcpprogressnotificationconst.TOOL_CALL_PROGRESS_TOKEN_PREFIX}sse-1`,
                    progress: 0,
                    total: 1
                }
            });
