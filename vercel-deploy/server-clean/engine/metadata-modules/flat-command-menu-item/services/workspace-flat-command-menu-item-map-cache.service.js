...
let WorkspaceFlatCommandMenuItemMapCacheService = class WorkspaceFlatCommandMenuItemMapCacheService extends _workspacecacheproviderservice.WorkspaceCacheProvider {
    async computeForCache(workspaceId) {
        const [commandMenuItems, applications, objectMetadatas, frontComponents, pageLayouts] = await Promise.all([
    ...
    constructor(commandMenuItemRepository, applicationRepository, objectMetadataRepository, frontComponentRepository, pageLayoutRepository){
        super(), this.commandMenuItemRepository = commandMenuItemRepository, this.applicationRepository = applicationRepository, this.objectMetadataRepository = objectMetadataRepository, this.frontComponentRepository = frontComponentRepository, this.pageLayoutRepository = pageLayoutRepository;
    }
};
WorkspaceFlatCommandMenuItemMapCacheService = _ts_decorate([
    ...
    _ts_param(4, (0, _typeorm.InjectRepository)(_pagelayoutentity.PageLayoutEntity)),
