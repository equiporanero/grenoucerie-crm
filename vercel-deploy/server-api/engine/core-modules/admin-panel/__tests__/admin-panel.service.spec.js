...
describe('AdminPanelConfigService', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        configService = module.get(_adminpanelconfigservice.AdminPanelConfigService);
    });
    ...
    describe('getConfigVariable', ()=>{
        ...
        it('should throw error when variable not found', ()=>{
            ...
            expect(()=>configService.getConfigVariable('INVALID_VAR')).toThrow('Config variable INVALID_VAR not found');
        });
    });
});
describe('AdminPanelVersionService', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        versionService = module.get(_adminpanelversionservice.AdminPanelVersionService);
    });
