...
const ALL_METADATA_ENTITY_BY_METADATA_NAME = {
    ...
    rolePermissionFlag: _rolepermissionflagentity.RolePermissionFlagEntity,
    permissionFlag: _permissionflagentity.PermissionFlagEntity,
    webhook: _webhookentity.WebhookEntity,
    applicationVariable: _applicationvariableentity.ApplicationVariableEntity,
    viewSort: _viewsortentity.ViewSortEntity,
    connectionProvider: _connectionproviderentity.ConnectionProviderEntity
};
