...
const _sanitizeoverridableentityeventbatchutil = require("../sanitize-overridable-entity-event-batch.util");
const makeViewFieldRecord = (overrides)=>({
        id: 'vf-1',
        workspaceId: 'ws-1',
        applicationId: 'app-1',
...
const makeBatch = (metadataName, events)=>({
...
describe('resolveOverridableEntityEventBatchOverrides', ()=>{
    describe('non-overridable entity (pass-through)', ()=>{
        it('should return the batch unchanged for entities without overrides config', ()=>{
            ...
            const result = (0, _sanitizeoverridableentityeventbatchutil.resolveOverridableEntityEventBatchOverrides)(batch);
    ...
    describe('override resolution', ()=>{
        it('should resolve overrides into base properties and strip overrides but keep isActive', ()=>{
            ...
            const result = (0, _sanitizeoverridableentityeventbatchutil.resolveOverridableEntityEventBatchOverrides)(batch);
            const createdRecord = result.events[0].properties.after;
        ...
        it('should resolve overrides on before for delete events', ()=>{
            ...
            const result = (0, _sanitizeoverridableentityeventbatchutil.resolveOverridableEntityEventBatchOverrides)(batch);
            const deletedRecord = result.events[0].properties.before;
...
//# sourceMappingURL=sanitize-overridable-entity-event-batch.util.spec.js.map