...
const _fromconnectionprovidermanifesttouniversalflatconnectionproviderutil = require("../from-connection-provider-manifest-to-universal-flat-connection-provider.util");
...
describe('fromConnectionProviderManifestToUniversalFlatConnectionProvider', ()=>{
    it('moves OAuth manifest fields into the resolved oauthConfig blob with defaults filled', ()=>{
        const result = (0, _fromconnectionprovidermanifesttouniversalflatconnectionproviderutil.fromConnectionProviderManifestToUniversalFlatConnectionProvider)({
...
//# sourceMappingURL=from-connection-provider-manifest-to-universal-flat-connection-provider.util.spec.js.map