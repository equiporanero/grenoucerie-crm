...
const _messagethreadworkspaceentity = require("../../../../../modules/messaging/common/standard-objects/message-thread.workspace-entity");
        ...
        searchVector: (0, _createstandardfieldflatmetadatautil.createStandardFieldFlatMetadata)({
            ...
            context: {
                ...
                settings: {
                    ...
                    asExpression: (0, _gettsvectorcolumnexpressionutil.getTsVectorColumnExpressionFromFields)(_messagethreadworkspaceentity.SEARCH_FIELDS_FOR_MESSAGE_THREAD)
                }
            },
            standardObjectMetadataRelatedEntityIds,
            dependencyFlatEntityMaps,
