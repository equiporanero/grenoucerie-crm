...
const _safeparseemailaddressesutil = require("../safe-parse-email-addresses.util");
describe('safeParseEmailAddresses', ()=>{
    it('should return every recipient from a multi-address header', ()=>{
        ...
        expect((0, _safeparseemailaddressesutil.safeParseEmailAddresses)('alice@example.com, bob@example.com, carol@example.com')).toHaveLength(3);
    });
    it('should preserve display names alongside addresses', ()=>{
        expect((0, _safeparseemailaddressesutil.safeParseEmailAddresses)('Alice <alice@example.com>, "Bob Smith" <bob@example.com>')).toEqual([
            {
    ...
    it('should default an absent display name to empty string, not undefined', ()=>{
        const [first] = (0, _safeparseemailaddressesutil.safeParseEmailAddresses)('alice@example.com');
    ...
    it('should drop entries that parse without an address', ()=>{
        ...
        expect((0, _safeparseemailaddressesutil.safeParseEmailAddresses)('NoAddressHere, bob@example.com')).toEqual([
            {
                address: 'bob@example.com',
                name: ''
            }
    ...
    it('should not split on commas inside quoted display names', ()=>{
        ...
        expect((0, _safeparseemailaddressesutil.safeParseEmailAddresses)('"Doe, John" <jd@example.com>, bob@example.com')).toEqual([
            {
...
//# sourceMappingURL=safe-parse-email-addresses.util.spec.js.map