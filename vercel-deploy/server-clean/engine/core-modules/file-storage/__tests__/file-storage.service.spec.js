...
describe('FileStorageService', ()=>{
    ...
    describe('path traversal protection', ()=>{
        ...
        const expectedValidPath = 'workspace-123/app-456/built-front-component/src/components/my-component.mjs';
        const REJECTED_FILE_PATHS = [
            {
                title: 'path traversal with ../',
                context: {
                    resourcePath: '../../../victim-ws/victim-app/built-front-component/secret.mjs'
                }
            },
            {
                title: 'absolute path',
            ...
            },
            {
                ...
                context: {
                    resourcePath: '../../../target-ws/target-app/built-front-component/file.js'
                }
            },
            {
        ...
        const ACCEPTED_FILE_PATHS = [
            ...
            },
            {
                ...
                context: {
                    ...
                    expectedStoragePath: 'workspace-123/app-456/built-front-component/a/b/c/d/e/f/deep-file.mjs'
                }
            },
            {
                ...
                context: {
                    ...
                    expectedStoragePath: 'workspace-123/app-456/built-front-component/v1.0.0/file.name.mjs'
                }
            },
            {
                ...
                context: {
                    ...
                    expectedStoragePath: 'workspace-123/app-456/built-front-component/.hidden/file.name.mjs'
                }
            }
        ];
        describe('readFile', ()=>{
            it.each((0, _testing1.eachTestingContextFilter)(REJECTED_FILE_PATHS))('should reject $title', ({ context })=>{
                expect(()=>service.readFile({
            ...
            it.each((0, _testing1.eachTestingContextFilter)(ACCEPTED_FILE_PATHS))('should accept $title', async ({ context })=>{
        ...
        describe('checkFileExists', ()=>{
            it.each((0, _testing1.eachTestingContextFilter)(REJECTED_FILE_PATHS))('should reject $title', ({ context })=>{
                expect(()=>service.checkFileExists({
                        ...validResourceIdentifier,
                        resourcePath: context.resourcePath
                    })).toThrow(expect.objectContaining({
                    code: _filestorageexception.FileStorageExceptionCode.ACCESS_DENIED
        ...
        describe('getPresignedUrl', ()=>{
            it.each((0, _testing1.eachTestingContextFilter)(REJECTED_FILE_PATHS))('should reject $title', async ({ context })=>{
        ...
        describe('writeFile', ()=>{
            ...
            it('should allow valid writes', async ()=>{
                ...
                expect(mockDriver.writeFile).toHaveBeenCalledWith(expect.objectContaining({
            ...
            describe('magic-byte backstop', ()=>{
                ...
                it('should accept buffer whose magic bytes match the path extension and persist the bytes-derived mime', async ()=>{
                    ...
                    expect(mockFileRepository.upsert).toHaveBeenCalledWith('workspace-123', expect.objectContaining({
                        mimeType: 'image/png'
                    }), expect.anything());
                });
                ...
                it('should persist application/typescript for a TypeScript source buffer (policy beats mrmime collision)', async ()=>{
                    await service.writeFile({
                        ...
                        sourceFile: Buffer.from('export const handler = () => null;', 'utf-8'),
                        settings: {
                            isTemporaryFile: false,
                            toDelete: false
                        }
        ...
        describe('deleteFolder', ()=>{
            const REJECTED_FOLDER_PATHS = [
                ...
                },
                {
                    ...
                    context: {
                        folderPath: 'my folder/data'
                    }
                },
                {
                    title: 'folder path with shell metacharacters',
                    context: {
                        folderPath: 'folder;rm -rf/'
                    }
                },
                {
                ...
                },
                {
                    ...
                    context: {
                        folderPath: 'src/components/index.ts'
                    }
                },
                {
                    title: 'file path with .json extension',
                    context: {
                        folderPath: 'config/settings.json'
                    }
                },
                {
                ...
                },
                {
                    ...
                    context: {
                        folderPath: 'archive.7z'
                    }
                }
            ];
            const ACCEPTED_FOLDER_PATHS = [
                {
                    title: 'UUID folder path',
                    context: {
                        folderPath: '8b2df3cc-23ad-4e1b-87fd-f880d4cefd58',
                        expectedStoragePath: 'workspace-123/app-456/built-front-component/8b2df3cc-23ad-4e1b-87fd-f880d4cefd58/'
                    }
                },
                {
                    ...
                    context: {
                        ...
                        expectedStoragePath: 'workspace-123/app-456/built-front-component/my-folder/'
                    }
                },
                {
                    ...
                    context: {
                        ...
                        expectedStoragePath: 'workspace-123/app-456/built-front-component/0000-0999/tmp200/toto/'
                    }
                }
            ];
            it.each((0, _testing1.eachTestingContextFilter)(REJECTED_FOLDER_PATHS))('should reject $title', async ({ context })=>{
            ...
            it.each((0, _testing1.eachTestingContextFilter)(ACCEPTED_FOLDER_PATHS))('should accept $title', async ({ context })=>{
