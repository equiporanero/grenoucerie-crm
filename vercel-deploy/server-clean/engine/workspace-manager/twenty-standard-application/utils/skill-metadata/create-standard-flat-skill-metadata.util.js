...
| Validate | script | \`python validate.py doc.docx\` |`,
    ...
    'view-building': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'view-building',
                name: 'view-building',
                label: 'View Building',
                description: 'Creating and configuring views (table, board/kanban, calendar) for objects to organize and visualize records',
...
- Explain what each view type does so users can make informed choices`,
    ...
    'view-filters-and-sorts': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'view-filters-and-sorts',
                name: 'view-filters-and-sorts',
                label: 'View Filters & Sorts',
                description: 'Adding filters and sorts to views to focus on relevant records based on user needs',
                icon: 'IconFilter',
...
- If complex filtering is needed (AND + OR), explain the logic clearly`,
    ...
    'custom-objects-cleanup': (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'custom-objects-cleanup',
                name: 'custom-objects-cleanup',
                label: 'Custom Objects Cleanup',
                description: 'Archiving custom objects from a workspace (e.g. dev seed objects like pets, rockets)',
                icon: 'IconArchive',
