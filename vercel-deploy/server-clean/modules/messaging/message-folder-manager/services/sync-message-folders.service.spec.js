...
const createMockMessageChannel = (overrides = {})=>({
        ...
        contactAutoCreationPolicy: _types.MessageChannelContactAutoCreationPolicy.NONE,
    ...
    beforeEach(async ()=>{
        ...
        const module = await _testing.Test.createTestingModule({
            providers: [
                ...
                {
                    provide: (0, _typeorm.getRepositoryToken)(_messagefolderentity.MessageFolderEntity),
    ...
    describe('syncMessageFolders', ()=>{
        ...
        describe('folder creation scenarios', ()=>{
            it('should create new folders when none exist locally', async ()=>{
                ...
                expect(mockMessageFolderRepository.save).toHaveBeenCalledWith(expect.objectContaining({
                    workspaceId,
                    name: 'INBOX',
                    externalId: 'inbox-ext',
